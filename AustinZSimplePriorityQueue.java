...
/**
 * Created by austinzhang on 4/14/16.
 */
public class AustinZSimplePriorityQueue<E extends Comparable<E>> implements AustinZPriorityQueue<E> {
    ArrayList<E> list;

    public AustinZSimplePriorityQueue() {
